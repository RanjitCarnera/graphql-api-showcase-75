...
import operationsData from '@/data/accountPermissionGroupOperations.json';
import { useFragmentScroll } from '../lib/utils';

const AccountPermissionsGroups = () => {
  ...
  return (
    <DocsLayout>
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Account Permissions Groups API</h1>
        
        <section className="mb-8">
          <p className="mb-6">
            The Account Permissions Groups API allows you to manage user permission groups and role-based access.
          </p>
        </section>
         ...
         <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-8">
          ...
          <TabsContent value="queries" className="space-y-6">
            ...
            <p className="mb-4">Use these queries to fetch information about  account permissions groups in different formats and contexts.</p>
          ...
          <TabsContent value="mutations" className="space-y-6">
            ...
            <p className="mb-4">Use these mutations to create, update, delete, and manage  account permissions groups.</p>
          ...
          : <>
            <h2 className="text-2xl font-bold mb-4">Fragments</h2>
              <p className="mb-4">
                These are GraphQL fragments used in account permissions groups queries and mutations.
              </p>
...
export default AccountPermissionsGroups;
